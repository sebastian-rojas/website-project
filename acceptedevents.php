...
$txt = " admin open accepted events".PHP_EOL;
fwrite($myfile, $txt);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>We Serve You INC | Accepted Events</title>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Accepted Events </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
                            <div class="col-md-12">
...
$query = mysqli_query($conn,"SELECT * FROM events WHERE status='accepted'");
if ($query){
