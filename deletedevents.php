...
$txt = " admin open deleted events".PHP_EOL;
fwrite($myfile, $txt);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>We Serve You INC | Deleted Events</title>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Deleted Events </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
                            <div class="col-md-12">
...
$query = mysqli_query($conn,"SELECT * FROM events WHERE status='deleted'");
if ($query){
