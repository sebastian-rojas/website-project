...
$txt = " admin open pending events".PHP_EOL;
fwrite($myfile, $txt);
}
?>
<!DOCTYPE html>
...
$query = mysqli_query($conn,"SELECT * FROM events where status='pending'");
if ($query){
		...
		$userdata=mysqli_fetch_assoc($result2);
                                ...
                                <div class='portlet box blue-hoki'>
                                    <div class='portlet-title'>
										...
										<input type='hidden' name='event_id' value=".$eventid." required>
                            <select class='form-control select2me select2-hidden-accessible' name='status'>
                            <option value='accepted'>accepted</option>
                            <option value='rejected'>rejected</option>
                            </select>
                            <input class='form-control' type='number' name='bill' placeholder='BILL'>
                            <button class='btn btn-default btn-sm' name='name' value='value' type='submit'>Update</button>
										</form>
                                        </div>
                                    </div>
