...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>We Serve You INC | Search User</title>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
							<form class="form-horizontal" method="post" role="form" ACTION="searchuser.php">
...
$txt = " admin search for customer".PHP_EOL;
fwrite($myfile, $txt);
...
$query = mysqli_query($conn,"SELECT * FROM events where customer_id='$customer_id'");
if ($query){
